...
export const galleryItems: GalleryItem[] = [
  {
    ...
    titleZh: "平衡木动作镜头",
    description: "A compact performance clip that works well as a keyframe-to-motion example for Gemini Omni image-to-video workflows.",
    descriptionZh: "一条更适合图生视频场景的动作样片：先锁住角色起始画面，再把运动感逐步推出来。",
    alt: "Gemini Omni video sample showing a gymnast walking across a balance beam.",
    altZh: "用于展示 Gemini Omni 图生视频工作流的平衡木动作视频样例。",
    afterImage: "/images/gallery/custom/omni-hero-4.png",
    beforeThumb: SHARED_BEFORE,
    videoUrl: "/videos/gallery/omni-hero-4.mp4",
    durationLabel: "05s",
  ...
  },
  {
    ...
    alt: "Gemini Omni narrative video sample showing a man running through a crowded street.",
    altZh: "用于展示 Gemini Omni 短剧与叙事镜头生成的街头奔跑视频样例。",
    afterImage: "/images/gallery/custom/omni-hero-6.png",
    beforeThumb: SHARED_AFTER,
    videoUrl: "/videos/gallery/omni-hero-6.mp4",
    durationLabel: "05s",
    aspectRatioLabel: "16:9",
    promptLabel: "Narrative clip",
  },
  {
    id: "omni-space-travel",
    useCase: "reference-video-generator",
    slug: "reference-video-generator",
    category: "Worldbuilding",
    title: "Space travel sequence",
    titleZh: "宇宙穿梭场景片段",
    description: "A full Gemini Omni clip that moves from stylized terrain into large-scale sci-fi worldbuilding.",
    descriptionZh: "一条完整的 Gemini Omni 场景视频，从体素地貌一路推进到更宏观的宇宙世界观。",
    alt: "Gemini Omni full video showing sci-fi worldbuilding and space travel.",
    altZh: "用于展示 Gemini Omni 宇宙世界构建与穿梭场景的完整视频案例。",
    afterImage: "/images/gallery/custom/omni-space-travel.png",
    beforeThumb: SHARED_BEFORE,
    videoUrl: "/videos/gallery/omni-space-travel.mp4",
    durationLabel: "15s",
    aspectRatioLabel: "16:9",
  ...
  },
  {
    ...
    alt: "Gemini Omni full action video showing a duel in an autumn forest.",
    altZh: "用于展示 Gemini Omni 秋林决斗镜头的完整动作视频案例。",
    afterImage: "/images/gallery/custom/omni-autumn-duel.png",
    beforeThumb: SHARED_BEFORE,
    videoUrl: "/videos/gallery/omni-autumn-duel.mp4",
    durationLabel: "13s",
    aspectRatioLabel: "16:9",
    promptLabel: "Full clip",
  },
