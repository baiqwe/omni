...
import HomeHeroContent, { HomeHeroSupport } from '@/components/home/HomeHeroContent';
...
export default async function HomePage(props: { params: Promise<{ locale: string }> }) {
    ...
    const heroHeading = await HomeHeroContent({ locale });
    const heroSupport = await HomeHeroSupport({ locale });
